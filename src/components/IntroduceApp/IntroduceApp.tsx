...
const IntroduceApp = () => {
  return (
    <Helmet>
      ...
      <meta property='og:title' content='Viva Wool' />
      ...
      <meta property='og:image' content='https://ibb.co/Nyqpsf1' />
      <meta property='og:url' content='https://vivawool.io.vn' />
      <meta property='og:type' content='website' />
      <meta name='twitter:card' content='summary_large_image' />
      <meta name='twitter:title' content='Viva Wool' />
      ...
      <meta name='twitter:image' content='https://ibb.co/Nyqpsf1' />
    </Helmet>
  )
}
